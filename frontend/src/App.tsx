...
import { Film, UploadCloud, AlertCircle } from 'lucide-react';
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-6">
        {projects.length === 0 ? (
          <div className="max-w-md mx-auto my-20 p-8 rounded-3xl bg-slate-900 border border-slate-800 text-center shadow-2xl">
            ...
            <h2 className="text-lg font-bold text-white mb-2">Welcome to ScriptBreakdown</h2>
            <p className="text-xs text-slate-400 mb-6 leading-relaxed">
              Create a film project and upload a screenplay (PDF, DOCX, TXT) to generate a structured, editable production breakdown.
            </p>
            <button
