...
validator_and_scorer = '''import json
...
'''
Path("backend/app/services/scheduling/validator.py").write_text(validator_and_scorer, encoding="utf-8")
print("Validator, QualityScorer, and ReviewAgent created.")
